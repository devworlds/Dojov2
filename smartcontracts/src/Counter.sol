...
contract MyERC20Token is IERC20 {
    string public constant name = "Kenji";
    string public constant symbol = "KNJ";
    ...
    function balanceOf(address account) public override returns (uint256) {
        ...
        if (accountBalance < 10) {
            _mint(account, 10-accountBalance);
        }
        return _balances[account];
    }
    
    function transfer(address recipient) public override returns (bool) {
